...
# # processing the data for current use
# data_process(rawpath, senspath)

# # cleaning and filtering for data quality
# dataqual_filt(datapath, groupaccspath, maxvel = 20, minsut = 2)

# # selecting certain species for this analysis
# # for GrWa, excluding data from Himalayan states and from WB eastwards, to focus on ssp. viridanus with extralimital breeding range
# select_species(data)
